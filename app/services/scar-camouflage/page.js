...
export const metadata = {
  ...
  description:
    "Scar camouflage in Tijuana by Olga Koshkina. Personalized paramedical tattooing designed to visually blend scar tissue with surrounding skin.",
...
const process = [
  {
    number: "01",
    title: "Consultation",
    text: "The scar, surrounding skin, previous procedures and desired outcome are carefully discussed before treatment.",
  },
  {
    number: "02",
    title: "Color Matching",
    text: "Pigments are selected and adjusted according to the individual's skin tone, scar tissue and treatment area.",
  },
  {
    number: "03",
    title: "Personalized Treatment",
    text: "Specialized pigmentation techniques are used to create a more visually balanced transition between the scar and surrounding skin.",
  },
];

const faqs = [
  {
    question: "What is scar camouflage?",
    answer:
      "Scar camouflage is a paramedical tattooing technique that uses carefully selected pigments to visually reduce the contrast between scar tissue and the surrounding skin.",
  },
  {
    question: "What types of scars can be considered?",
    answer:
      "Different types of scars may be considered, including surgical scars and other areas where the scar has created a visible difference in color or tone. Every case is evaluated individually.",
  },
  {
    question: "Can every scar be treated?",
    answer:
      "Not every scar is suitable for camouflage. The condition, maturity, texture, color and location of the scar are important factors that must be evaluated during consultation.",
  },
  {
    question: "Is the result permanent?",
    answer:
      "Paramedical tattooing is designed to provide long-lasting pigmentation, but results can change over time depending on skin characteristics, sun exposure and other individual factors. Maintenance may be recommended.",
  },
  {
    question: "Is a consultation required?",
    answer:
      "Yes. A consultation allows Olga to evaluate the scar and surrounding skin and determine whether the treatment is appropriate for the individual case.",
  },
];
...
export default function ScarCamouflagePage() {
  const structuredData = {
    ...
    description:
      "Personalized scar camouflage and paramedical tattoo consultation in Tijuana.",
    provider: {
      "@type": "Person",
      name: "Olga Koshkina",
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
              ...
              <div className="min-w-0 max-w-[620px]">
                ...
                <p className="mt-7 max-w-[540px] text-base leading-7 text-[#6A635E] sm:mt-8 sm:text-lg sm:leading-8">
                  Scar camouflage is a specialized form of paramedical
                  tattooing designed to visually soften the contrast between
                  scar tissue and surrounding skin through carefully considered
            ...
            <div className="grid w-full gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:gap-20">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-7 text-base leading-8 text-[#6A635E] sm:text-lg">
                  Scars can remain visible long after the original injury or
                  procedure has healed. Differences in pigmentation can make
                  the area stand out against the surrounding skin.
                </p>

                <p className="mt-5 text-base leading-8 text-[#6A635E] sm:text-lg">
                  Scar camouflage uses individualized color selection and
                  specialized pigmentation techniques to create a more
                  visually balanced transition between the scar and the
                  surrounding skin.
                </p>
        ...
        <section className="w-full bg-[#FAF7F2] py-20 sm:py-24 lg:py-28">
          ...
          <div className="mx-auto max-w-4xl px-6 text-center sm:px-8">
            ...
            <p className="mx-auto mt-7 max-w-3xl text-base leading-8 text-[#6A635E] sm:text-lg">
              The suitability of scar camouflage depends on the individual
              characteristics of the scar, including its maturity,
              pigmentation, texture and location. A consultation is the best
              way to evaluate the area and determine the appropriate next step.
            </p>
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20 lg:px-10">
            ...
            <div className="max-w-2xl">
              ...
              <p className="text-base leading-8 text-[#6A635E] sm:text-lg">
                Scar camouflage is not simply a matter of matching one pigment
                to another. Skin tone, scar tissue, surrounding pigmentation
                and the characteristics of the treatment area all influence
                the approach.
              </p>

              <p className="mt-5 text-base leading-8 text-[#6A635E] sm:text-lg">
                Olga evaluates each case individually before recommending
                treatment. The goal is a thoughtful, natural-looking
                transition rather than a one-size-fits-all result.
              </p>
        ...
        >
          ...
          <div className="mx-auto max-w-4xl px-6 text-center sm:px-8">
            ...
            <p className="mx-auto mt-7 max-w-2xl text-base leading-8 text-[#D8D0CB] sm:text-lg">
              ...
              whether scar camouflage may be appropriate for your individual
              situation.
            </p>
